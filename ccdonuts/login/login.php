...
<html lang="ja">
    ...
    <body>
        ...
        <main>
            <div class="section1">
                <div class="pan"><a href="../index.php">Top</a> > <a href="../menu/index.php">ログイン</a></div><!-- ぱんくずメニュー一部変更する -->
                <div class="text2"><p>ようこそ　ゲスト様</p></div>
            </div> <!-- 共有終了 -->
            ...
            <div class="section2">
                <ul>
                    ...
                    <a href="../signup/signup.php"><p class="login">ログイン</a></p>
                </ul>
            </div>
                <a href="../credit/credit.php"><p class="kaiin">会員登録はこちら</a></p>
